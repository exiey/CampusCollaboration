...
import com.campus.common.config.RuoYiConfig;
...
public class ExcelUtil<T>
{
    ...
    private Map<String, CellStyle> annotationDataStyles(Workbook wb)
    {
        ...
        for (Object[] os : fields)
        {
            ...
            if (Collection.class.isAssignableFrom(field.getType()))
            {
                ...
                List<Field> subFields = getFieldsListWithAnnotation(subClass, Excel.class);
    ...
    public void addField(List<Object[]> fields, Field field)
    {
        ...
        if (field.isAnnotationPresent(Excel.class))
        {
            ...
            if (Collection.class.isAssignableFrom(field.getType()))
            {
                ...
                ParameterizedType pt = (ParameterizedType) field.getGenericType();
                Class<?> subClass = (Class<?>) pt.getActualTypeArguments()[0];
                subFieldsMap.put(fieldName, getFieldsListWithAnnotation(subClass, Excel.class));
            }
        }
     ...
     * @return 带有指定注解的字段列表
     */
    private static List<Field> getFieldsListWithAnnotation(Class<?> cls, Class<? extends java.lang.annotation.Annotation> annotationCls)
    {
