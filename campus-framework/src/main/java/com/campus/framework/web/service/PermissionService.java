...
import com.campus.framework.security.context.PermissionContextHolder;
...
public class PermissionService
{
    ...
    public boolean hasPermi(String permission)
    {
        ...
        if (StringUtils.isNull(loginUser) || CollUtil.isEmpty(loginUser.getPermissions()))
        {
            return false;
        }
    ...
    public boolean hasRole(String role)
    {
        ...
        LoginUser loginUser = SecurityUtils.getLoginUser();
        if (StringUtils.isNull(loginUser) || CollUtil.isEmpty(loginUser.getUser().getRoles()))
        {
            return false;
        }
