...
public interface SysUserMapper
{
    ...
    /**
     * 根据条件分页查询用户列表（MyBatis-Plus分页）
     * 
     * @param page 分页对象
     * @param sysUser 用户信息
     * @return 用户信息集合信息
     */
    public IPage<SysUser> selectUserPage(Page<SysUser> page, @Param("user") SysUser sysUser);
    ...
    /**
     * 根据条件分页查询已配用户角色列表（MyBatis-Plus分页）
     * 
     * @param page 分页对象
     * @param user 用户信息
     * @return 用户信息集合信息
     */
    public IPage<SysUser> selectAllocatedPage(Page<SysUser> page, @Param("user") SysUser user);
    ...
    /**
     * 根据条件分页查询未分配用户角色列表（MyBatis-Plus分页）
     * 
     * @param page 分页对象
     * @param user 用户信息
     * @return 用户信息集合信息
     */
    public IPage<SysUser> selectUnallocatedPage(Page<SysUser> page, @Param("user") SysUser user);
